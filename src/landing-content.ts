...
const content: Record<Lang, LandingContent> = {
  en: {
    ...
    metaDesc:
      'SneakRead disguises any web page as VS Code, Word, Google Docs, Notion, Slack, Lark and more, so you can read anything while looking busy. Free, in your browser, one-key boss screen.',
    heroSub: 'Paste any link. SneakRead makes it look like real work — so you can read anything at your desk.',
    cta: 'Open SneakRead',
    featuresTitle: 'Features',
    faqTitle: 'FAQ',
    features: [
      { t: 'Nine disguises', d: 'VS Code, Word, Google Docs, Notion, Slack, Lark, and more — full screen.' },
    ...
    faqs: [
      ...
      { q: 'Which apps can it mimic?', a: 'VS Code, Word, Google Docs, Notion, Slack, Lark, Excel, and Outlook.' },
    ],
  },
  zh: {
    metaTitle: '摸鱼 SneakRead — 上班摸鱼神器，把网页伪装成 VS Code / Word / 文档',
    metaDesc:
      '摸鱼把任何网页整屏伪装成 VS Code、Word、Google 文档、Notion、Slack、飞书 等，让你光明正大地摸鱼。纯浏览器、免费、一键老板键。',
    heroSub: '粘贴任意链接，摸鱼把它变成一份正经工作的样子——上班也能读任何东西。',
    cta: '开始摸鱼',
    featuresTitle: '功能',
    faqTitle: '常见问题',
    features: [
      { t: '九种伪装', d: 'VS Code、Word、Google 文档、Notion、Slack、飞书 等九种，整屏还原。' },
    ...
    faqs: [
      ...
      { q: '能伪装成哪些软件？', a: 'VS Code、Word、Google 文档、Notion、Slack、飞书、飞书文档、Excel、Outlook。' },
    ],
  },
  es: {
    metaTitle: 'SneakRead — lee cualquier cosa en el trabajo, disfrazada de VS Code, Word o Docs',
    metaDesc:
      'SneakRead disfraza cualquier página web como VS Code, Word, Google Docs, Notion, Slack, Lark y más, para que leas lo que sea sin dejar de parecer ocupado. Gratis, en tu navegador.',
    ...
    features: [
      { t: 'Nueve disfraces', d: 'VS Code, Word, Google Docs, Notion, Slack, Lark y más, a pantalla completa.' },
    ...
    faqs: [
      ...
      { q: '¿Qué apps puede imitar?', a: 'VS Code, Word, Google Docs, Notion, Slack, Lark, Excel y Outlook.' },
    ],
  },
  hi: {
    metaTitle: 'SneakRead — काम पर कुछ भी पढ़ें, VS Code, Word या Docs के भेस में',
    metaDesc:
      'SneakRead किसी भी वेब पेज को VS Code, Word, Google Docs, Notion, Slack, Lark आदि जैसा बना देता है, ताकि आप व्यस्त दिखते हुए कुछ भी पढ़ सकें। मुफ़्त, आपके ब्राउज़र में।',
    ...
    features: [
      { t: 'नौ भेस', d: 'VS Code, Word, Google Docs, Notion, Slack, Lark और अधिक — पूरी स्क्रीन।' },
    ...
    faqs: [
      ...
      { q: 'यह कौन-से ऐप की नकल कर सकता है?', a: 'VS Code, Word, Google Docs, Notion, Slack, Lark, Excel और Outlook।' },
    ],
  },
  ar: {
    metaTitle: 'SneakRead — اقرأ أي شيء في العمل متخفّيًا كـ VS Code أو Word أو Docs',
    metaDesc:
      'يموّه SneakRead أي صفحة ويب كأنها VS Code أو Word أو Google Docs أو Notion أو Slack أو Lark وغيرها، لتقرأ أي شيء بينما تبدو مشغولًا. مجاني، داخل متصفّحك.',
    heroSub: 'الصق أي رابط. يجعله SneakRead يبدو كعمل حقيقي — لتقرأ أي شيء على مكتبك.',
    cta: 'افتح SneakRead',
    featuresTitle: 'المزايا',
    faqTitle: 'الأسئلة الشائعة',
    features: [
      { t: 'تسعة أقنعة', d: 'VS Code وWord وGoogle Docs وNotion وSlack وLark والمزيد — بملء الشاشة.' },
    ...
    faqs: [
      ...
      { q: 'أي تطبيقات يمكنه محاكاتها؟', a: 'VS Code وWord وGoogle Docs وNotion وSlack وLark وExcel وOutlook.' },
    ],
  },
  pt: {
    metaTitle: 'SneakRead — leia qualquer coisa no trabalho, disfarçado de VS Code, Word ou Docs',
    metaDesc:
      'O SneakRead disfarça qualquer página como VS Code, Word, Google Docs, Notion, Slack, Lark e mais, para você ler qualquer coisa parecendo ocupado. Grátis, no seu navegador.',
    heroSub: 'Cole um link. O SneakRead faz parecer trabalho de verdade — para você ler qualquer coisa na sua mesa.',
    cta: 'Abrir SneakRead',
    featuresTitle: 'Recursos',
    faqTitle: 'Perguntas frequentes',
    features: [
      { t: 'Nove disfarces', d: 'VS Code, Word, Google Docs, Notion, Slack, Lark e mais — em tela cheia.' },
    ...
    faqs: [
      ...
      { q: 'Quais apps ele imita?', a: 'VS Code, Word, Google Docs, Notion, Slack, Lark, Excel e Outlook.' },
    ],
  },
  ru: {
    metaTitle: 'SneakRead — читай что угодно на работе под видом VS Code, Word или Docs',
    metaDesc:
      'SneakRead маскирует любую веб-страницу под VS Code, Word, Google Docs, Notion, Slack, Lark и другие, чтобы вы читали что угодно, оставаясь «занятым». Бесплатно, в браузере.',
    ...
    features: [
      { t: 'Девять маскировок', d: 'VS Code, Word, Google Docs, Notion, Slack, Lark и другие — на весь экран.' },
    ...
    faqs: [
      ...
      { q: 'Какие приложения он имитирует?', a: 'VS Code, Word, Google Docs, Notion, Slack, Lark, Excel и Outlook.' },
    ],
  },
  ja: {
    metaTitle: 'SneakRead — 仕事中に何でも読む。VS Code・Word・Docs に偽装',
    metaDesc:
      'SneakRead は任意のウェブページを VS Code・Word・Google ドキュメント・Notion・Slack・Lark などに偽装し、忙しそうに見せながら何でも読めます。無料・ブラウザ完結。',
    heroSub: 'リンクを貼るだけ。SneakRead が本物の仕事のように見せるので、デスクで何でも読めます。',
    cta: 'SneakRead を開く',
    featuresTitle: '機能',
    faqTitle: 'よくある質問',
    features: [
      { t: '9 つの偽装', d: 'VS Code・Word・Google ドキュメント・Notion・Slack・Lark など全画面で。' },
    ...
    faqs: [
      ...
      { q: 'どのアプリに偽装できますか？', a: 'VS Code・Word・Google ドキュメント・Notion・Slack・Lark・Excel・Outlook。' },
    ],
  },
  fr: {
    metaTitle: 'SneakRead — lisez tout au travail, déguisé en VS Code, Word ou Docs',
    metaDesc:
      'SneakRead déguise n’importe quelle page en VS Code, Word, Google Docs, Notion, Slack, Lark et plus, pour lire tout en ayant l’air occupé. Gratuit, dans votre navigateur.',
    ...
    faqTitle: 'FAQ',
    features: [
      { t: 'Neuf déguisements', d: 'VS Code, Word, Google Docs, Notion, Slack, Lark et plus — en plein écran.' },
    ...
    faqs: [
      ...
      { q: 'Quelles applis peut-il imiter ?', a: 'VS Code, Word, Google Docs, Notion, Slack, Lark, Excel et Outlook.' },
    ],
  },
  de: {
    metaTitle: 'SneakRead — bei der Arbeit alles lesen, getarnt als VS Code, Word oder Docs',
    metaDesc:
      'SneakRead tarnt jede Webseite als VS Code, Word, Google Docs, Notion, Slack, Lark und mehr, damit du alles liest und beschäftigt wirkst. Kostenlos, im Browser.',
    ...
    faqTitle: 'FAQ',
    features: [
      { t: 'Neun Tarnungen', d: 'VS Code, Word, Google Docs, Notion, Slack, Lark und mehr — im Vollbild.' },
    ...
    faqs: [
      ...
      { q: 'Welche Apps kann es imitieren?', a: 'VS Code, Word, Google Docs, Notion, Slack, Lark, Excel und Outlook.' },
    ],
  },
}
