...
const content: Record<Lang, LandingContent> = {
  en: {
    ...
    faqTitle: 'FAQ',
    features: [
      { t: '15 disguises', d: 'VS Code, Claude Code, Word, WPS, Notion, Slack, Lark, DingTalk, WeCom, Teams, Gmail and more — full screen.' },
    ...
    faqs: [
      ...
      { q: 'Which apps can it mimic?', a: 'VS Code, Claude Code, Word, WPS, Google Docs, Notion, Slack, Lark, DingTalk, WeCom, Teams, Gmail, Excel, and Outlook.' },
    ],
  },
  zh: {
    ...
    faqTitle: '常见问题',
    features: [
      { t: '15 种伪装', d: 'VS Code、Claude Code、Word、WPS、Notion、飞书、钉钉、企业微信、Slack、Teams、Gmail 等 15 种，整屏还原。' },
    ...
    faqs: [
      ...
      { q: '能伪装成哪些软件？', a: 'VS Code、Claude Code、Word、WPS 文字、Google 文档、Notion、Slack、飞书、飞书文档、钉钉、企业微信、Teams、Gmail、Excel、Outlook。' },
    ],
  },
  es: {
    ...
    features: [
      { t: '15 disfraces', d: 'VS Code, Claude Code, Word, WPS, Notion, Slack, WeCom, Teams, Gmail y más, a pantalla completa.' },
    ...
    faqs: [
      ...
      { q: '¿Qué apps puede imitar?', a: 'VS Code, Claude Code, Word, WPS, Google Docs, Notion, Slack, Lark, DingTalk, WeCom, Teams, Gmail, Excel y Outlook.' },
    ],
  },
  hi: {
    ...
    features: [
      { t: '15 भेस', d: 'VS Code, Claude Code, Word, WPS, Notion, Slack, WeCom, Teams, Gmail और अधिक — पूरी स्क्रीन।' },
    ...
    faqs: [
      ...
      { q: 'यह कौन-से ऐप की नकल कर सकता है?', a: 'VS Code, Claude Code, Word, WPS, Google Docs, Notion, Slack, Lark, DingTalk, WeCom, Teams, Gmail, Excel और Outlook।' },
    ],
  },
  ar: {
    ...
    features: [
      { t: '15 قناعًا', d: 'VS Code وClaude Code وWord وWPS وNotion وSlack وWeCom وTeams وGmail والمزيد — بملء الشاشة.' },
    ...
    faqs: [
      ...
      { q: 'أي تطبيقات يمكنه محاكاتها؟', a: 'VS Code وClaude Code وWord وWPS وGoogle Docs وNotion وSlack وLark وDingTalk وWeCom وTeams وGmail وExcel وOutlook.' },
    ],
  },
  pt: {
    ...
    features: [
      { t: '15 disfarces', d: 'VS Code, Claude Code, Word, WPS, Notion, Slack, WeCom, Teams, Gmail e mais — em tela cheia.' },
    ...
    faqs: [
      ...
      { q: 'Quais apps ele imita?', a: 'VS Code, Claude Code, Word, WPS, Google Docs, Notion, Slack, Lark, DingTalk, WeCom, Teams, Gmail, Excel e Outlook.' },
    ],
  },
  ru: {
    ...
    features: [
      { t: '15 маскировок', d: 'VS Code, Claude Code, Word, WPS, Notion, Slack, WeCom, Teams, Gmail и другие — на весь экран.' },
    ...
    faqs: [
      ...
      { q: 'Какие приложения он имитирует?', a: 'VS Code, Claude Code, Word, WPS, Google Docs, Notion, Slack, Lark, DingTalk, WeCom, Teams, Gmail, Excel и Outlook.' },
    ],
  },
  ja: {
    ...
    faqTitle: 'よくある質問',
    features: [
      { t: '15 種類の偽装', d: 'VS Code・Claude Code・Word・WPS・Notion・Slack・WeCom・Teams・Gmail など全画面で。' },
    ...
    faqs: [
      ...
      { q: 'どのアプリに偽装できますか？', a: 'VS Code・Claude Code・Word・WPS・Google ドキュメント・Notion・Slack・Lark・DingTalk・WeCom・Teams・Gmail・Excel・Outlook。' },
    ],
  },
  fr: {
    ...
    faqTitle: 'FAQ',
    features: [
      { t: '15 déguisements', d: 'VS Code, Claude Code, Word, WPS, Notion, Slack, WeCom, Teams, Gmail et plus — en plein écran.' },
    ...
    faqs: [
      ...
      { q: 'Quelles applis peut-il imiter ?', a: 'VS Code, Claude Code, Word, WPS, Google Docs, Notion, Slack, Lark, DingTalk, WeCom, Teams, Gmail, Excel et Outlook.' },
    ],
  },
  de: {
    ...
    faqTitle: 'FAQ',
    features: [
      { t: '15 Tarnungen', d: 'VS Code, Claude Code, Word, WPS, Notion, Slack, WeCom, Teams, Gmail und mehr — im Vollbild.' },
    ...
    faqs: [
      ...
      { q: 'Welche Apps kann es imitieren?', a: 'VS Code, Claude Code, Word, WPS, Google Docs, Notion, Slack, Lark, DingTalk, WeCom, Teams, Gmail, Excel und Outlook.' },
    ],
  },
}
